            ...
            <div className="p-4 md:w-1/4">
                <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden shadow-xl">
                    ...
                    <div className="p-3">
                        ...
                        <h1 className="title-font font-roboto text-lg font-bold text-gray-900 mb-3">Title</h1>
                        ...
                        <div className="flex items-center justify-center flex-wrap ">
                            ...
                            <Link to={`/`} className='my-3 no-underline ' onClick={handleClick} ><button className=" text-white bg-blue-600 border-0 py-2 px-4 focus:outline-none hover:bg-blue-800 rounded-md text-sm flex mx-auto font-ubuntu cursor-pointer">Explore</button></Link>
