            ...
            <div className='container font-poppins mx-4 '>
                <section className='text-center my-4 mx-2'>
                    ...
                    <div className="px-2 mx-auto my-2 ">
                        <button class=" cursor-pointer font-ubuntu flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Button</button>
                    </div>
                </section>
